...
//        });
    ...
    private void createGrid() {
        ...
        grid = new Grid<>(SimulationModel.class);

        CallbackDataProvider<SimulationModel, Void> provider = DataProvider.fromCallbacks(query -> simulationService
                                .fetch(query.getOffset(), query.getLimit()).stream(), query -> simulationService.count());
